local palette = require("eletro-colors").config.palette
local flavor = require("eletro-colors").config.flavor
local colors = require("colors")

-- if palette/flavor not exists, set it default
local s = colors[palette][flavor] or colors["ubuntu"]["main"]
